...
//     it('primitive object', () => {
//       // TYPES.primitiveObject.forEach(value => expect(() => helperClass.object = value as any).toThrowError('Invalid type!'));
//     });
//     it('string', () => {
//       TYPES.string.forEach(value => expect(() => helperClass.object = value as any).toThrowError('Invalid type!'));
//     });
//     it('primitive number', () => {
//       TYPES.number.forEach(value => expect(() => helperClass.object = value as any).toThrowError('Invalid type!'));
//     });
//     it('primitive boolean', () => {
//       TYPES.boolean.forEach(value => expect(() => helperClass.object = value as any).toThrowError('Invalid type!'));
//     });
//     it('primitive symbol', () => {
//       TYPES.symbol.forEach(value => expect(() => helperClass.object = value as any).toThrowError('Invalid type!'));
//     });
//     it('function', () => {
//       TYPES.function.forEach(value => expect(() => helperClass.object = value as any).toThrowError('Invalid type!'));
//     });
//     it('NotExtendingTestClass1', () => {
//       expect(() => helperClass.notExtendingTestClass1 = new TestClass1() as any).toThrowError('Invalid type!');
//     });
//   });
//
